...
def train_model():
    model = mymodel.AwesomeSpamClassificationModel(mymodel.OUTPUT_SIZE)
    model.to(device)
    ...
    mymodel.train(model, trainloader, loss_function, optimizer=optimizer, epochs=20, print_every=10)
